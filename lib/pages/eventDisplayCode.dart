...
// class EventDisplayCode extends StatefulWidget {
//   const EventDisplayCode({Key? key}) : super(key: key);

//   @override
//   State<EventDisplayCode> createState() => _EventDisplayCodeState();
// }

// class _EventDisplayCodeState extends State<EventDisplayCode> {
...
//           // Filter events based on the current year and month
...
//       final month = formatMonthString(event.dateStart.toString());
...
//     // Show past events if the switch is enabled
//     if (!_showPastEvents) {
//       filtered = filtered.where((event) {
//         final eventYear = event.dateStart.year;
//         final eventMonth = event.dateStart.month;
...
//                 (eventMonth <= now.month )) &&
//             (eventYear == now.year &&
//                 eventMonth == now.month || eventDay <= now.day);
//       }).toList();
//     }
//     // other filters
